    ...
    <div class="all1">
        ...
        <div class="right" id="right">
            ...
            <table cellspacing="0" cellpadding="0" border="0" style="text-align:center">
                ...
                <c:forEach items="${pb4.users}" var="emp" varStatus="vs">
            ...
            <div class="page">
                <a href="${pageContext.request.contextPath}/One_MeetingServlet?meeting_id=${meeting_id}&currentPage=${pb4.currentPage==1?1:pb4.currentPage-1}">&lt;&lt;上一页</a>
                &nbsp;&nbsp;第${pb4.currentPage}页/共${pb4.totalPages}页&nbsp;&nbsp;
                <a href="${pageContext.request.contextPath}/One_MeetingServlet?meeting_id=${meeting_id}&currentPage=${pb4.currentPage==pb4.totalPages?pb4.totalPages:pb4.currentPage+1}">下一页&gt;&gt;</a>
            </div>
            <br>
            </center>
        </div>
