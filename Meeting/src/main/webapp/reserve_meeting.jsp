...
<div class="all">
    <div class="all1">
        ...
        <div class="right" id="right">
            <span style="margin-left:25px">个人中心 > 我的预定</span>
            <h4 style="margin-left:50px">我预定的会议：</h4>
            <center>
                <table cellspacing="0" cellpadding="0" border="0" width="950px" style="text-align:center">
                    ...
                    <c:forEach items="${pb2.emps}" var="emp" varStatus="vs">
                        <tr ${vs.count%2==1?"style='text-align:center;background-color:white'":"style='text-align:center;background-color:#f1f1f1'"}>
                            ...
                            <td><button type="button" ><a href="CancelServlet?meeting_id=${emp.meeting_id}">查看/撤销</a></button></td>
                        </tr>
                    </c:forEach>
                </table>
                <div class="page">
                    <a href="${pageContext.request.contextPath}/ReserveServlet?currentPage=${pb2.currentPage==1?1:pb2.currentPage-1}">&lt;&lt;上一页</a>
                    &nbsp;&nbsp;第${pb2.currentPage}页/共${pb2.totalPages}页&nbsp;&nbsp;
                    <a href="${pageContext.request.contextPath}/ReserveServlet?currentPage=${pb2.currentPage==pb2.totalPages?pb2.totalPages:pb2.currentPage+1}">下一页&gt;&gt;</a>
                </div>
            </center>
        </div>
        <div class="bottom">
